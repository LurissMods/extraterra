...
/*
* Author: Luriss
* Simulates the body's core tempeature. Note that this function uses a portion of the ace_advanced_fatigue_fnc_getMetabolicCosts function from ACE.
*
* Arguments:
...
*
* Example:
* [] call exterra_lifeSupport_fnc_updateCoreTemp;
*
* Public: No
*/
