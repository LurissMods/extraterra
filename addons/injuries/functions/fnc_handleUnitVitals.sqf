...
//[_unit,_deltaT,_syncValues] call FUNC(hyperthermia);
//[_unit,_deltaT,_syncValues] call FUNC(hypothermia);
//[_unit,_deltaT,_syncValues] call FUNC(ars);
//[_unit] call FUNC(cardiacArrest);
