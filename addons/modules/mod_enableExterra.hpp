...
{
    displayName = CSTRING(enableExterra_displayName);				// Name displayed in the menu
    ...
    {
        description = CSTRING(enableExterra_desc);	// Short description, will be formatted as structured text
