...
_primaryIcon = getText (configFile >> "CfgWeapons" >> _primaryWeapon >> "exterra_huds_icon");
_handgunIcon = getText (configFile >> "CfgWeapons" >> _handgunWeapon >> "exterra_huds_icon");
_launcherIcon = getText (configFile >> "CfgWeapons" >> _launcherWeapon >> "exterra_huds_icon");
...
if (count _currentThrowable == 0) then {
    ...
    _grenadeIcon = getText (configFile >> "CfgMagazines" >> (_currentThrowable select 0) >> "exterra_huds_icon");
