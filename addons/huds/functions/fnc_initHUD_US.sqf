...
(GVAR(hudOutline_US)#0) ctrlSetTextColor GVAR(CBAset_hudOutlineColorUS);
(GVAR(hudOutline_US)#0) ctrlSetFade 1;
(GVAR(hudOutline_US)#0) ctrlCommit 0;

(GVAR(hudLines_US)#0) ctrlSetTextColor GVAR(CBAset_hudLinesColorUS);
(GVAR(hudLines_US)#0) ctrlSetFade 1;
(GVAR(hudLines_US)#0) ctrlCommit 0;

(GVAR(hudText_US)#0) ctrlSetText LLSTRING(hudText_US);
(GVAR(hudText_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
...
(GVAR(hudAirProgress_US)#0) ctrlSetTextColor GVAR(CBAset_airBarColorUS);
(GVAR(hudAirProgress_US)#0) ctrlSetFade 1;
(GVAR(hudAirProgress_US)#0) ctrlCommit 0;

(GVAR(hudBattProgress_US)#0) progressSetPosition 1;
(GVAR(hudBattProgress_US)#0) ctrlSetTextColor GVAR(CBAset_battBarColorUS);
(GVAR(hudBattProgress_US)#0) ctrlSetFade 1;
...
(GVAR(hudExtAtm_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudExtAtm_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudEnvironRad_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudEnvironRad_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudRadTotal_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudRadTotal_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudTempInt_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudTempInt_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudTempExt_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudTempExt_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudTmeDangTemp_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudTmeDangTemp_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudTempWatt_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudTempWatt_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudBearing_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudBearing_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudGrid_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudGrid_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudRange_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudRange_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudAirEstTime_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudAirEstTime_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudBattEstTime_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudBattEstTime_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudMagCount_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudMagCount_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudFireMode_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudFireMode_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudWeaponZero_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudWeaponZero_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudGrenadeCount_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudGrenadeCount_text_US)#0) ctrlSetFade 1;
(GVAR(hudGrenadeCount_text_US)#0) ctrlCommit 0;

//(GVAR(hudWeaponPrimary_US)#0) ctrlSetPosition HUD_WEAPON_PRIMARY_US_POS;
(GVAR(hudWeaponPrimary_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudWeaponPrimary_US)#0) ctrlSetFade 1;
(GVAR(hudWeaponPrimary_US)#0) ctrlCommit 0;

// /(GVAR(hudWeaponSecondary_US)#0) ctrlSetPosition HUD_WEAPON_SECONDARY_US_POS;
(GVAR(hudWeaponSecondary_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudWeaponSecondary_US)#0) ctrlSetFade 1;
(GVAR(hudWeaponSecondary_US)#0) ctrlCommit 0;

//(GVAR(hudWeaponLauncher_US)#0) ctrlSetPosition HUD_WEAPON_LAUNCHER_US_POS;
(GVAR(hudWeaponLauncher_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudWeaponLauncher_US)#0) ctrlSetFade 1;
(GVAR(hudWeaponLauncher_US)#0) ctrlCommit 0;

//(GVAR(hudWeaponGrenade_US)#0) ctrlSetPosition HUD_WEAPON_GRENADE_US_POS;
(GVAR(hudWeaponGrenade_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudWeaponGrenade_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name0_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name0_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr0_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr0_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp0_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp0_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink0_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink0_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name1_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name1_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr1_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr1_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp1_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp1_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink1_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink1_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name2_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name2_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr2_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr2_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp2_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp2_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink2_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink2_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name3_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name3_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr3_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr3_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp3_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp3_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink3_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink3_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name4_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name4_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr4_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr4_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp4_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp4_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink4_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink4_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name5_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name5_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr5_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr5_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp5_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp5_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink5_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink5_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name6_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name6_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr6_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr6_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp6_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp6_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink6_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink6_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name7_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name7_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr7_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr7_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp7_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp7_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink7_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink7_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name8_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name8_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr8_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr8_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp8_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp8_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink8_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_datalink8_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_name9_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_name9_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_hr9_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_hr9_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_bp9_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
(GVAR(hudSquad_bp9_text_US)#0) ctrlSetFade 1;
...
(GVAR(hudSquad_datalink9_text_US)#0) ctrlSetTextColor GVAR(CBAset_hudTextColorUS_normal);
