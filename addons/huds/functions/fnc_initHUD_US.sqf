...
(GVAR(hudBattProgress_US)#0) ctrlSetTextColor GVAR(battBarColor_US_cbaSetting);
...
(GVAR(hudExtAtm_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudEnvironRad_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudRadTotal_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudTempInt_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudTempExt_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudTmeDangTemp_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudTempWatt_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudBearing_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudGrid_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudRange_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudAirEstTime_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudBattEstTime_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudMagCount_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudFireMode_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudWeaponZero_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudGrenadeCount_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudWeaponPrimary_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudWeaponSecondary_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudWeaponLauncher_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudWeaponGrenade_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name0_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr0_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp0_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink0_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name1_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr1_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp1_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink1_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name2_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr2_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp2_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink2_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name3_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr3_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp3_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink3_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name4_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr4_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp4_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink4_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name5_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr5_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp5_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink5_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name6_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr6_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp6_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink6_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name7_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr7_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp7_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink7_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name8_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr8_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp8_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink8_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_name9_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_hr9_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_bp9_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
...
(GVAR(hudSquad_datalink9_text_US)#0) ctrlSetTextColor GVAR(textColor_US_cbaSetting);
