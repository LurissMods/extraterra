...
#define DEFAULT_MIN_IFF_INFANTRY_FOV 0.25
#define DEFAULT_MAX_IFF_VEHICLES_FOV 1
#define DEFAULT_MAX_IFF_AIRCRAFT_FOV 1.33
#define DEFAULT_MAX_IFF_OTHER_FOV 0.75
