...
<p align="center">
    <a href="https://github.com/LurissMods/extraterra/releases/latest">
        <img src="https://img.shields.io/badge/Version-0.0.0-blue?style=flat-square" alt="Extraterra Version">
    </a>
    ...
    <img src="https://img.shields.io/github/actions/workflow/status/LurissMods/extraterra/arma.yml?style=flat-square&label=Validate" alt="Validate">
</p>
...
1. Find and replace all instances of `Extraterra` with the mod's name.
2. Find and replace all instances of `extraterra` with the mod's name *and no spaces*.
   - This should be the name of the repository on GitHub.
3. Find and replace all instances of `exterra` with the mod's prefix.
   - This should be all lowercase.
4. Find and replace all instances of `EXTA` with the mod's acronym.
   - This should be all uppercase.
5. After the initial Steam upload, find and replace all instances of `MOD_ID` with the mod's Steam Workshop id.

For third parties, make sure to also replace `LurissMods` with your Github username / organization name, and to replace `Luriss` with your username.

**Extraterra** (EXTA) aims to...
